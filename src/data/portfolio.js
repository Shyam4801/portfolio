export default [
   {
      title: 'Multi Agent Rollout for Bayesian Optimization',
      imgUrl: 'assets/mabo.gif',
      stack: ['Python'],
      link: 'https://github.com/Shyam4801/marobo',
   ...
   },
   {
      ...
      stack: ['Python'],
      link: 'https://github.com/Shyam4801/non-myopic_bo',
      description: 'A project developing an efficient rollout acquisition function for Bayesian Optimization, enhancing its performance in complex scenarios.',
   },
   {
   ...
   {
      title: 'Optimized Product Catalog Search with Custom B+ Tree',
      imgUrl: 'assets/b+.png',
      stack: ['Java'],
      link: 'https://github.com/Shyam4801/bplustree',
   ...
   },
   {
      ...
      link: 'https://github.com/Shyam4801/graph_algorithm_visualizer',
      description: 'A graph algorithm visualizer that allows users to visualize and understand graph algorithms.',
   },
   {
      title: 'Two Tower Recommendation System',
      imgUrl: 'assets/2tower.png',
